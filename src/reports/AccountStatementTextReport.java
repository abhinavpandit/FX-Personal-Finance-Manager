 ...
 * @author HP
 */
public class AccountStatementTextReport
{
    ...
    public AccountStatementTextReport(DataModel dataModel) throws IOException 
    {
    ...
    public static void main(String [] args)
    {
        try 
        {
            new AccountStatementTextReport();
        } 
        catch (SQLException ex) {
            Logger.getLogger(AccountStatementTextReport.class.getName()).log(Level.SEVERE, null, ex);
